...
#define PWR_SRC_Pin GPIO_PIN_3
#define PWR_SRC_GPIO_Port GPIOF
#define TFT_BR_Pin GPIO_PIN_6
#define TFT_BR_GPIO_Port GPIOF
#define IN_R_Pin GPIO_PIN_0
#define IN_R_GPIO_Port GPIOA
#define LDAC_TOGGLE_Pin GPIO_PIN_2
#define LDAC_TOGGLE_GPIO_Port GPIOA
#define LDAC_CTRL_Pin GPIO_PIN_3
#define LDAC_CTRL_GPIO_Port GPIOA
#define AUX1_IO_Pin GPIO_PIN_1
#define AUX1_IO_GPIO_Port GPIOB
...
#define OE_DO_AP_Pin GPIO_PIN_5
#define OE_DO_AP_GPIO_Port GPIOG
#define DOSR_CLR_Pin GPIO_PIN_6
#define DOSR_CLR_GPIO_Port GPIOG
#define RCK_DO_IP_Pin GPIO_PIN_7
#define RCK_DO_IP_GPIO_Port GPIOG
